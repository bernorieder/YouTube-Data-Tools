<?php include("html_head.php"); ?>
	...
	<div class="rowTab">
		<div class="fullTab">
			...
			<p>Related channel data are not retrieved via the API, but scraped from YT's web interface. To reduce the number of requests, this module caches channel data for three days. Remember that channels can opt out of this feature.</p>
