...
<tr>
	<td colspan="2">
		...
		<h2>What are channel or video ids and how can I find them?</h2>
		
		<p>Many of the modules require a video or channel id as input. These can normally be found in the respective YouTube URLs.
		...
		<p>Since the public version of the script runs on a server that does a bunch of different things, this is not possible due to resource
		...
		but networks with > 100K nodes should be easily doable with 4 GB.</p>
		...
		<p>The full source code is available on <a href="https://github.com/bernorieder/YouTube-Data-Tools" target="_blank">github</a>. You'll also find installation instructions there.</p>
	</td>
</tr>
</table>
